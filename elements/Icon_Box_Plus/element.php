...
\Breakdance\ElementStudio\registerElementForEditing(
    "TechsiCustom\\IconBoxPlus",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class IconBoxPlus extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Alignment",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'left', 'text' => 'Left'], ['value' => 'center', 'text' => 'Center'], ['value' => 'right', 'text' => 'Right']]],
        true,
        false,
        [],
      ), c(
      ...
      "borders",
       ['type' => 'popout']
        ...
        "Position",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['text' => 'Top', 'value' => 'top'], ['value' => 'left', 'text' => 'Left'], ['text' => 'Right', 'value' => 'right']]],
        false,
        false,
        [],
      ), c(
        ...
        "Top At",
        [],
        ['type' => 'breakpoint_dropdown', 'layout' => 'inline', 'condition' => [[['path' => 'design.icon.position', 'operand' => 'is one of', 'value' => ['left', 'right']]]]],
        false,
        false,
        [],
      ), c(
        ...
        "Left At",
        [],
        ['type' => 'breakpoint_dropdown', 'layout' => 'inline', 'condition' => [[['path' => 'design.icon.position', 'operand' => 'is one of', 'value' => ['top']]]]],
        false,
        false,
        [],
      ), c(
        ...
        "Vertical Alignment",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'top', 'text' => 'Top'], ['value' => 'middle', 'text' => 'Middle'], ['value' => 'bottom', 'text' => 'Bottom']]],
        false,
        false,
        [],
      ), c(
        ...
        "Color Mode",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'static', 'text' => 'Static'], ['text' => 'Gradient', 'value' => 'gradient']]],
        false,
        false,
        [],
      ), c(
        ...
        "Static color",
        [],
        ['type' => 'color', 'layout' => 'inline', 'colorOptions' => ['type' => 'solidOnly'], 'condition' => [[['path' => 'design.icon.color_mode', 'operand' => 'equals', 'value' => 'static']]]],
        false,
        false,
        [],
      ), c(
        ...
        "Gradient",
        [],
        ['type' => 'gradient', 'layout' => 'vertical', 'colorOptions' => ['type' => 'gradientOnly'], 'condition' => [[['path' => 'design.icon.color_mode', 'operand' => 'equals', 'value' => 'gradient']]]],
        false,
        false,
        [],
      ), c(
    ...
    static function contentControls()
    {
        ...
        "Show Icon",
        [],
        ['type' => 'toggle', 'layout' => 'vertical', 'default' => true],
        false,
        false,
        [],
      ), c(
        ...
        "Icon Class",
        [],
        ['type' => 'text', 'layout' => 'vertical', 'textOptions' => ['multiline' => false, 'format' => 'plain']],
        false,
        false,
        [],
      ), c(
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.content.title'], ['accepts' => 'string', 'path' => 'content.content.text'], ['accepts' => 'string', 'path' => 'content.content.button.text'], ['accepts' => 'url', 'path' => 'content.content.button.link']];
    }
    ...
    {
        return ['design.button.custom.size.full_width_at', 'design.button.style', 'design.icon.top_at', 'design.icon.left_at'];
    }
